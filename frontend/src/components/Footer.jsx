...
import { FaFacebookF, FaTwitter, FaInstagram, FaYoutube, FaEnvelope,FaMapMarkerAlt, FaCcVisa, FaCcMastercard, FaCcPaypal, FaCcAmex, FaApplePay } from 'react-icons/fa';
          ...
          <div className={footerStyles.grid}>
            ...
            <div>
                ...
                <p className={footerStyles.brandText}>
                    Bringing you the freshest organic produce since 2020. Our mission is to deliver farm-fresh
            ...
            <div>
                <h3 className={footerStyles.sectionTitle}>
                    <FiLink className={footerStyles.sectionIcon} />QuickLinks
                    </h3>     
                    <ul className={footerStyles.linkList}>
                        {['Home', 'Item', 'Contact'].map((item,idx) => (
                            <li key={idx} >
             ...
             <div>
                <h3 className={footerStyles.sectionTitle}>
                    <FaPhone className={footerStyles.sectionIcon} />Contact Us
                </h3>
            ...
            <div className={footerStyles.paymentSection}>
                <h4 className={footerStyles.paymentTitle}>
                    ...
                    We Accept Major Payment Method
                </h4>
            ...
            <div className={footerStyles.attribution}>
                <div className={footerStyles.attributionBadge}>
                    ...
                    <span className={footerStyles.attributionText}>
                        Designed By{' '}
                        <a href="" target='_blank' className={footerStyles.attributionLink}>
                            Harsimar
                        </a>
                    </span>
                </div>

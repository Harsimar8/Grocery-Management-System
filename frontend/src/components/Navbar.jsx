...
//       return () => window.addEventListener('authStateChanged',handler)
//     },[])
...
//        ${scrolled ? navbarStyles.scrolledNav : navbarStyles.unscontrollednav}`}>
...
//           <img src={logo} alt="RushBasket Logo" className={`${navbarStyles.logoImage} ${scrolled ? 'h-10 w-10 ' : 'h-12 w-12'}`}/>
...
//                 ${activeTab === item.path ? navbarStyles.activeNavItem : navbarStyles.inactiveNavItem}`}>
...
//                     className={ navbarStyles.loginLink} aria-label='Logout'>
...
//                 <FaShoppingCart className={`${navbarStyles.cartIcon} ${cartBounce ? 
//                     'animate-bounce' : ''}`}/>
//                     {cartCount > 0 && (
...
//         <span className={navbarStyles.mobileLogoText}></span>
//        </div>
//        </div>
...
//                 <span className={navbarStyles.mobileItemIcon}>{item.name}</span>
...
//                   <FiUser className={navbarStyles.loginButton} />
//                   Login
//                 </Link>
//               )}
//             </div>

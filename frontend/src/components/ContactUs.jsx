...
import { FaCheck, FaEnvelope, FaPaperPlane, FaUser,FaPhone, FaTag, FaComment} from 'react-icons/fa'
            ...
            <div className={contactStyles.centeredContainer}>
                ...
                <form onSubmit={handleSubmit} className={contactStyles.form}>
                        ...
                        <div className={contactStyles.inputContainer}>
                            ...
                            <input type="text" id='name' name='name' value={formData.name} onChange={handleChange}  className={contactStyles.formInput} placeholder='John Doe' required />
                        ...
                        <div className={contactStyles.inputContainer}>
                            ...
                            <input type="email" id='email' name='email' value={formData.email} onChange={handleChange}  className={contactStyles.formInput} placeholder='johndoe@gmail.com' required />
                        ...
                        <div className={contactStyles.inputContainer}>
                            ...
                            <input type="tel" id='phone' name='phone' value={formData.phone} onChange={handleChange}  className={contactStyles.formInput} placeholder=' (123) 456-7890' required />
                        ...
                        <div className={contactStyles.inputContainer}>
                            ...
                            className={contactStyles.formTextarea} placeholder='Type your message here....' required>
